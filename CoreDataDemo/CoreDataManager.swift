...
class CoreDataManager {
    ...
    private lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CoreDataDemo", withExtension: "xcdatamodeld")!
    ...
    func getNSManagedObjectContext() -> NSManagedObjectContext {
        
        return self.createNewManagedObjectContext()
    }
